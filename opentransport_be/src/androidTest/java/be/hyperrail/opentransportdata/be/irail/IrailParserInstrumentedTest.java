...
public class IrailParserInstrumentedTest {
    ...
    IrailApiParser parser = new IrailApiParser(new IrailStationsDataProvider(InstrumentationRegistry.getTargetContext()));
    ...
    public void liveboardParsingTest() throws Exception {
        ...
        assertEquals(TransportOccupancyLevel.HIGH, liveboard.getStops()[1].getOccupancyLevel());
        // END tests stop 1
    }
    ...
    public void routeParsingTest() throws Exception {
        ...
        Assert.assertArrayEquals(null, route.getVehicleAlerts()[0]);
